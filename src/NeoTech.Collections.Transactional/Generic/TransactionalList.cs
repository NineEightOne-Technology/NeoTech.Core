...
namespace NeoTech.Collections.Transactional.Generic
{
		...
		, IList
	{
		...
		public T this[int index]
		{
			...
			set
			{
				if (_transactionManager.HookToCurrentTransaction())
				{
					...
					_commandManager.AddAction(() => _internalStorage[indexScoped] = currentItemScoped);
				}
		...
		public int Add(object value)
		{
			...
			if (_transactionManager.HookToCurrentTransaction())
				_commandManager.AddAction(() => ((IList)_internalStorage).RemoveAt(insertionIndex));
		...
		public void Insert(int index, T item)
		{
			if (_transactionManager.HookToCurrentTransaction())
			{
				...
				_commandManager.AddAction(() => _internalStorage.RemoveAt(index));
			}
		...
		public void RemoveAt(int index)
		{
			...
			if (_transactionManager.HookToCurrentTransaction())
			{
				...
				_commandManager.AddAction(() => _internalStorage.Insert(indexScoped, currentItemScoped));
			}
		}
